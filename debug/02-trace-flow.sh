...
echo "  debug/01-test-upload.sh      - Upload test file and monitor (start here next time)"
echo "  debug/03-check-core.sh       - Core account resources"
echo "  debug/04-check-rps.sh        - RPS account resources"

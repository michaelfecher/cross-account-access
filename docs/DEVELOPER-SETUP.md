...
- **Input Bucket:** `alice-core-input-bucket-111111111111-eu-west-1`
- **Output Bucket:** `alice-core-output-bucket-111111111111-eu-west-1`
...
{
  "Records": [{
    "body": "{\"detail\":{\"bucket\":{\"name\":\"${PREFIX}-core-input-bucket-${ACCOUNT_CORE_ID}-${REGION}\"},\"object\":{\"key\":\"test.txt\"}}}"
  }]
}
EOF
...
# Check Core input bucket policy (Core account)
aws s3api get-bucket-policy \
  --bucket ${PREFIX}-core-input-bucket-${ACCOUNT_CORE_ID}-${REGION} \
  --profile core-account
```

...
echo "  S3 Bucket:     ${PREFIX}-core-test-bucket-${ACCOUNT_CORE_ID}-${REGION}"
echo "  Stack:         ${PREFIX}-core-stack"
echo ""
echo "Next steps:"
echo "  1. Coordinate with Core team to deploy ${PREFIX}-StackCore"
echo "  2. Test: aws s3 cp test-data/sample-input.txt s3://${PREFIX}-core-test-bucket-${ACCOUNT_CORE_ID}-${REGION}/input/test.txt --profile core-account"
